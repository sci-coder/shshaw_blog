...
This is where I write about the things I find beautiful across **physics, computation, AI, evolution, and simulation** — from statistical mechanics and Monte Carlo methods to generative models and complex systems. Expect a mix of technical notes, experiments, and the occasional [bit of fun]({{< ref "/fun" >}}).

## More about me

- 📄 Read my [**CV**]({{< ref "/about/cv" >}}) — full experience, education, research, and publications.
- 🧪 Some [**Electron Microscopy Art**]({{< ref "/fun/electron-microscopy-art" >}}) — colourised micrographs, from my materials-science days.
- Outside work I play the flute, travel, and read non-fiction — especially philosophy.

## Get in touch

- **Email:** [syed.hashim.shahh@gmail.com](mailto:syed.hashim.shahh@gmail.com)
- **LinkedIn:** [linkedin.com/in/syed-hashim-shah](https://www.linkedin.com/in/syed-hashim-shah/)
- **GitHub:** [github.com/sci-coder](https://github.com/sci-coder)
